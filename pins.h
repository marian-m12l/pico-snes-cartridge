...
#define SNES_RESET_PIN       35
#define SNES_RESET_PIN_MASK  0x0000000800000000
...
#define SNES_ALL_PINS_MASK (SNES_ADDR_PINS_MASK | SNES_DATA_PINS_MASK | SNES_CTRL_PINS_MASK | SNES_RESET_PIN_MASK | SNES_CIC_PINS_MASK | DEBUG_PINS_MASK)
